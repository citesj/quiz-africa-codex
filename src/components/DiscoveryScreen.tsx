...
export const DiscoveryScreen = ({
  ...
  return (
    ...
    >
      ...
      <section className="space-y-2 rounded-2xl bg-color-ochre/10 px-4 py-3 shadow-photo" aria-label="Curiosidade do país">
        <h3 className="font-title text-sm font-bold uppercase tracking-wide text-color-ink/85">Curiosidade</h3>
        <p className="font-body text-color-ink">{country.funFact}</p>
      </section>
